...
## 🏗️ 인프라 아키텍처
![시스템 아키텍처](https://i.postimg.cc/3ryHKLCt/drawio.png)
...
## 🔧 내 역할(조현수) : 백엔드 시스템 구현 (차용박사 채무 상환 프로세스)

##### 차용증 생성부터 상환까지 전체 거래 프로세스를 담당하는 백엔드 시스템을 설계하고 구현했습니다. Event Driven 아키텍처를 도입하여 실시간 입금 감지 및 처리가 가능한 자동화된 상환 시스템을 구축했으며, 트랜잭션 관리를 통해 데이터 정합성을 보장했습니다. 특히 가상계좌와 차용증을 1:1로 매핑하여 안전한 에스크로 기반의 채무 상환 프로세스를 구현했습니다.


![차용 박사 채무 상환 프로세스](https://i.postimg.cc/HsCGmbYK/Untitled-diagram-2024-11-09-074857.png)
...
## 🎉 Flow Chart
<img src="./asset/flow-chart.svg" height="1000" alt="거래 프로세스 플로우차트">
